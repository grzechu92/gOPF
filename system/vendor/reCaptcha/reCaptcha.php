...
class reCaptcha
{
    ...
    public function isValid()
    {
        ...
        $response = $this->request(self::RECAPTCHA_VERIFY_SERVER, '/recaptcha/api/verify',
            array('privatekey' => self::$privateKey, 'remoteip' => $_SERVER['REMOTE_ADDR'], 'challenge' => $challenge, 'response' => $response));
