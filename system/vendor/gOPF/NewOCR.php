...
class NewOCR
{
    ...
    {
        $result = $this->sendRequest('', array('userfile' => '@' . $file . ';type=' . mime_content_type($file), 'l' => 'pol', 'ocr' => 1), array(CURLOPT_HTTPHEADER => array('Content-type: multipart/form-data')));
    ...
    {
        $result = $this->sendRequest('', array('l' => 'pol', 'url' => $url, 'ocr' => 1));
