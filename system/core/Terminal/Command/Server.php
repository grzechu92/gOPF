...
class Server extends \System\Terminal\Command
{
    ...
    private function displaySlotsInfo()
    {
        ...
        $head = array('pid' => 'Process ID', 'state' => 'State', 'client' => 'Client IP', 'time' => 'Request time', 'host' => 'Request host', 'request' => 'Request content',);

        $rows = array();
        $rows[] = $head;

        $length = array();
        $align = array(STR_PAD_BOTH, STR_PAD_BOTH, STR_PAD_BOTH, STR_PAD_BOTH, STR_PAD_RIGHT, STR_PAD_RIGHT,);
