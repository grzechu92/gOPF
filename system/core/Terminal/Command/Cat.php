 ...
 */
class Cat extends \System\Terminal\Command
{
    /**
    ...
    public function execute()
    {
        ...
        $path = $this->buildPath($this->getValue(), $session);
    ...
    {
        return str_replace(DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR, DIRECTORY_SEPARATOR,
            __ROOT_PATH . $session->pull()->path . $file);
    }
}
