...
class Session extends Singleton
{
    ...
    /**
     * If session synchronization is enabled, sync it on destruct, otherwise save it normally. If session is empty,
     * don't save it, and remove driver.
     */
     ...
     *
     * @param bool $return Return debug method content?
     *
     * @return string Debug content if required
     */
